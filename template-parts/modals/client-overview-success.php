<div class="cure-modal client-overview-success hidden" style="display:none" data-modal="client-overview-success">
    <div class="inner">
        <div class="cure-modal-header">
            <h3>Client Overview sent for Approval!</h3>
        ...
        <div class="cure-modal-body">
            ...
            <ul>
                ...
                <li>approve and send it to the respective client</li>
            </ul>
